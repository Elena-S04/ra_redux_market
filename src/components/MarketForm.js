...
export default function MarketForm() {
  ...
  const handleSubmit = (event) => {
    ...
    dispatch(addProduct(form.title, form.price, form.discount, form.image));
  ...
  return (
    <div className="MarketForm">
      ...
      <form className="MarketForm__form" onSubmit={handleSubmit}>
        <label>
          <div className="MarketForm__label">Название игрушки</div>
          <input
        ...
        <label>
          <div className="MarketForm__label">Стоимость</div>
          <input
            className="MarketForm__input"
            name="price"
            onChange={handleChange}
        ...
        <label>
          <div className="MarketForm__label">Стоимость со скидкой</div>
          <input
            className="MarketForm__input"
            name="discount"
            onChange={handleChange}
